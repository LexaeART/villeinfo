...
<head>
  ...
  <title>Documents | Vie communale | Mairie de la commune de Ville | Hauts-de-France</title>
  <!-- Link CSS -->
        ...
        <div class="col-12" id="breadcrumbs">
          <div class="row">
            <div class="offset-1 col-lg-5 col-xs-11">
              <p>
                <a href="accueil_ville">Accueil</a> \ <a href="vill_infos">Vill'infos</a> \ Documents
              </p>
            </div>
          </div>
        </div>
